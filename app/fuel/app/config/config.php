...
return array(
	...
	'errors' => array(
		...
		'continue_on' => array(E_DEPRECATED, E_USER_DEPRECATED),
	 ...
	 *
	 *  コンテナには C / C.utf8 / POSIX しかロケールが無く、コア既定値の en_US では
	 *  setlocale() が失敗して毎リクエスト警告がログに記録される。
	 *  このアプリはロケール依存の書式を使っていない（日付は date('Y-m-d') 固定、
	 *  表示文言は日本語をハードコード）ため、setlocale() を行わない。
	 */
